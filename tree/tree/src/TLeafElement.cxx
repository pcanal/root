...
////////////////////////////////////////////////////////////////////////////////
/// Given a composition of TStreamerInfo's EReadWrite for a numerical type
/// return the in-memory length
void TLeafElement::SetLenType(Int_t datatype)
{
   Int_t bareType = datatype;
