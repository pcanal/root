...
void R__zipBLAST(unsigned char *cxlevels, int *srcsize, char *src, int *tgtsize, char **tgts,
                 int tgt_number, int *irep, EDataType datatype = EDataType::kNoType_t);
...
void R__zipBLAST(unsigned char cxlevel, int *srcsize, char *src, int *tgtsize, char *tgt, int *irep, EDataType datatype = EDataType::kNoType_t);
